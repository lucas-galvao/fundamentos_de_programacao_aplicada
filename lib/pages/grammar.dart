      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (NExpression.contains('<CONV_POOL>') &&
              NExpression.contains('<FC>')) {
            modelInfo.writeFlattenDropout(NExpression);
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => ConvPool()));
          } else {
          ...
          Column(
            ...
            children: [
              ElevatedButton(
                ...
                child: const Text('CONV_POOL', style: TextStyle(fontSize: 20)),
                onPressed: () {
                  setState(() {
              ...
              ElevatedButton(
                style: raisedButtonStyle(DefaultForeground, DefaultBackground),
                child: const Text('FLATTEN', style: TextStyle(fontSize: 20)),
                onPressed: () {
                  setState(() {
              ...
              ElevatedButton(
                style: raisedButtonStyle(DefaultForeground, DefaultBackground),
                child: const Text('FC', style: TextStyle(fontSize: 20)),
                onPressed: () {
                  setState(() {
              ...
              ElevatedButton(
                style: raisedButtonStyle(DefaultForeground, DefaultBackground),
                child: const Text('DROPOUT', style: TextStyle(fontSize: 20)),
                onPressed: () {
                  setState(() {
  ...
  return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
            ...
            content: const Text(
              'Build a valid grammar to continue',
              style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                  fontSize: 20),
